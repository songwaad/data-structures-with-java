...
public class Array extends javax.swing.JFrame {
    ...
    public void Insert(int K, int N) {
        ...
        id[K] = Integer.parseInt(jTextField6.getText());
        name[K] = jTextField7.getText();
        position[K] = jTextField8.getText();
        rating[K] = Integer.parseInt(jTextField12.getText());
        value[K] = Float.parseFloat(jTextField9.getText());
        team[K] = jTextField13.getText();
        N++;
        row++;
    }  //Exit
    ...
    public void Sort() {
        for (int K = 0; K < row - 1; K++) {
            int PTR = 0;
            while (PTR < ((row - 1) - K)) {
                if (rating[PTR] > rating[PTR + 1]) {
                    int temp1 = id[PTR];
                    String temp2 = name[PTR];
                    String temp3 = position[PTR];
                    int temp4 = rating[PTR];
                    float temp5 = value[PTR];
                    String temp6 = team[PTR];
                    id[PTR] = id[PTR + 1];
                    id[PTR + 1] = temp1;
                    name[PTR] = name[PTR + 1];
                    name[PTR + 1] = temp2;
                    position[PTR] = position[PTR + 1];
                    position[PTR + 1] = temp3;
                    rating[PTR] = rating[PTR + 1];
                    rating[PTR + 1] = temp4;
                    value[PTR] = value[PTR + 1];
                    value[PTR + 1] = temp5;
                    team[PTR] = team[PTR + 1];
                    team[PTR + 1] = temp6;
                }
    ...
    public void Delete(int K) { //(int LA[], int N, int K, int ITEM ){  //Inserting Operation
        jTextField15.setText(String.valueOf(id[K]));
        jTextField17.setText(name[K]);
        jTextField18.setText(position[K]);
        jTextField19.setText(String.valueOf(rating[K]));
        jTextField20.setText(String.valueOf(value[K]));
        jTextField16.setText(team[K]);
        for (int J = K; J < row - 1; J++) {
            id[J] = id[J + 1];
            name[J] = name[J + 1];
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        // set data in array
        try {
            id[row] = Integer.parseInt(jTextField1.getText());
            name[row] = jTextField2.getText();
            position[row] = jTextField3.getText();
            rating[row] = Integer.parseInt(jTextField4.getText());
            value[row] = Float.parseFloat(jTextField11.getText());
            team[row] = jTextField5.getText();

            // show data on table
            jTable1.setValueAt(id[row], row, 0);
            jTable1.setValueAt(name[row], row, 1);
            jTable1.setValueAt(position[row], row, 2);
            jTable1.setValueAt(rating[row], row, 3);
            jTable1.setValueAt(value[row], row, 4);
            jTable1.setValueAt(team[row], row, 5);
            row++;
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        while (K <= (UB - 1)) {
            jTextArea1.setText(jTextArea1.getText()
                    + "id : " + id[K] + " name : " + name[K] + " position : " + position[K] + " rating : " + rating[K]
                    + " value : " + value[K] + " team : " + team[K] + "\n");
            K++;
        }
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        // TODO add your handling code here:
        try {
            Insert(Integer.parseInt(jTextField10.getText()), row);
            //fresh Table
            for (int i = 0; i < row; i++) {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        while (K <= row - 1) {            //Step 2 
            jTextArea2.setText(jTextArea2.getText() + "\n" + id[K] + "    "
                    + name[K] + "    " + position[K] + "    " + rating[K] + "    " + value[K]
                    + "    " + team[K] + "\n");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (result > -1) {
            ...
            jTextArea3.setText(jTextArea3.getText() + "\n" + "------------------------------------------------------------------------------------------\n");
            jTextArea3.setText(jTextArea3.getText() + "\n" + id[result] + "    "
                    + name[result] + "    " + position[result] + "    " + rating[result] + "    " + value[result]
                    + "    " + team[result] + "\n");
        } else
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        try {
            Delete(Integer.parseInt(jTextField21.getText()));
